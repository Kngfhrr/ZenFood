...
export class Admin extends React.Component {
  ...
  onAddFood = () => {
    ...
    this.setState({ item: "", price: "", added_items: items });
  };
    ...
    return (
      <div>
        ...
        <div className="add-form">
          ...
          <div>
            <button onClick={this.onAddFood} className="add-button">
              Add
            </button>
          </div>
        </div>
        ...
        <div className="table">
          <span className="menu-on-today">
            menu on {moment().format("DD MMM")} (today)
          </span>
          ...
          {add.map((item, index) => (
            <div key={index}>
              ...
              <div className="table-head">
                ...
                <div onClick={() => this.onDelete(index)} className="box-close">
          ...
          <button onClick={this.addItem} className="table-button">
            Add dish
          </button>
        </div>
      </div>
